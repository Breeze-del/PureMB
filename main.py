...
if __name__ == '__main__':
    ...
    parser.add_argument('--reg_weight', type=float, default=0.005, help='')
    parser.add_argument('--log_reg', type=float, default=0.05, help='')
    ...
    parser.add_argument('--decay', type=float, default=0.0, help='')
    ...
    parser.add_argument('--model_name', type=str, default='yelp', help='')
    ...
    model = PureMB(args, dataset).to(args.device)
    if args.gpu_no == 2:
